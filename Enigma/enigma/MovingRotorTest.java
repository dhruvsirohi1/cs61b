...
public class MovingRotorTest {
    ...
    @Test
    public void checkRotorConvertForward() {
        setRotor("I", NAVALA, "");
        rotor.set(3);
        assertEquals("Wrong convert for A", 2, rotor.convertForward(0));
        rotor.advance();
        assertEquals("Wrong convert for A", 7, rotor.convertForward(0));
        Rotor rotor2 = new MovingRotor("III",
                new Permutation(NAVALA.get("III"), UPPER), "");
        rotor2.set('X');
        assertEquals("Wrong convert for V", 9, rotor2.convertForward(21));

    }

    @Test
    public void checkRotorConvertBackward() {
        setRotor("IV", NAVALA, "");
        rotor.set('L');
        assertEquals("Wrong convert for Z", 9, rotor.convertBackward(25));
    }
    @Test
