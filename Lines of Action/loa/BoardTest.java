...
public class BoardTest {
    ...
    static final Piece[][] BOARD4 = {
            { BP, EMP, EMP, EMP, EMP, EMP, WP, WP },
            { EMP, EMP, EMP, EMP, EMP, EMP, WP, EMP },
            { EMP, EMP, EMP, EMP, EMP, EMP, WP, EMP },
            { EMP,  BP,  WP,  BP,  WP, EMP, EMP, EMP },
            { EMP,  WP,  BP,  WP,  WP, EMP, EMP, BP },
            { EMP, EMP,  BP,  BP,  WP,  WP,  WP, EMP },
            { EMP,  WP,  WP,  WP, EMP, EMP, EMP, BP },
    ...
    public void testContiguous1() {
        ...
        b3.makeMove(Move.mv("a1-a2"));
        assertFalse("Board 3 black contiguous?", b3.piecesContiguous(BP));
